...
<h1 class="ct fb">商品管理系統 - 修改資料</h1>
<p class="ct"><a href="index.php">回主畫面</a></p>
<form action="" method="post" name="formFix" id="formFix">
  <table class="table table-bordered table-striped table-hover" style="background:#F0F8FF">
    ...
    <tr>
      <td>戲劇名稱</td><td><input type="text" name="dName" id="dName"></td>
    </tr>

    <tr>
      <td>類型</td><td><input type="text" name="category" id="category"></td>
    </tr>

    <tr>
      <td>年份</td><td><input type="text" name="year" id="year" placeholder="XXXX-XX-XX"></td>
    </tr>

    <tr>
      <td>集數</td><td><input type="text" name="episode" id="episode" ></td>
    </tr>

    <tr>
      <td>戲劇介紹</td><td><textarea name="intro" type="text" id="intro" cols="50" rows="4"></textarea></td>
    </tr>

    <tr>
      <td>國家</td><td><input name="region" type="text" id="region"></td>
    </tr>

    <tr>
      <td>連結</td><td><input name="link" type="text" id="link"></td>
    </tr> 
   
    <td  class="ct">
      <input class="ct" type="submit" name="update" value="更新資料"/>
    </td>
...
if (isset($_POST['update']))
{
    ...
    $query = "UPDATE drama SET dName='$dName', category='$category', year='$year' WHERE dNo='$your_id' ";
