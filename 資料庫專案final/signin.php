<?php 
    ...
    function signedIn() {
      echo '<div class="dropdown-menu" aria-labelledby="navbarDropdown">';
      echo '<a class="dropdown-item" href="fav-show.php">收藏夾</a>';
         ...
         <ul class="navbar-nav mr-auto">
           ...
           <li class="nav-item dropdown">
             ...
             <div class="dropdown-menu" aria-labelledby="navbarDropdown">
               ...
               <a class="dropdown-item" href="index.php?category=k_stroy">劇情劇</a>
             </div>
           </li>
           <li class="nav-item dropdown">
             <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
             ...
             <div class="dropdown-menu" aria-labelledby="navbarDropdown">
               ...
               <a class="dropdown-item" href="index.php?category=j_stroy">劇情劇</a>
             </div>
           </li>
           ...
           <li class="nav-item dropdown">
             ...
             <div class="dropdown-menu" aria-labelledby="navbarDropdown">
               ...
               <a class="dropdown-item" href="index.php?category=t_stroy">劇情劇</a>
             </div>
           </li>
           <li class="nav-item dropdown">
             <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
             ...
             <div class="dropdown-menu" aria-labelledby="navbarDropdown">
               ...
               <a class="dropdown-item" href="index.php?category=h_stroy">劇情劇</a>
             </div>
           </li>
         </ul>
      ...
      <div class="container d-flex flex-column">
        <div class="row align-items-center justify-content-center no-gutters min-vh-100">
          <div class="col-8 col-md-6 col-lg-7 offset-md-1 order-md-2 mt-auto mt-md-0 pt-8 pb-4 py-md-11">
            ...
            <!-- Image -->
            <img src="signin.png" alt="..." class="img-fluid">
          ...
          <div class="col-12 col-md-5 col-lg-4 order-md-1 mb-auto mb-md-0 pb-8 py-md-11">
            ...
            <!-- Form -->
            <form class="mb-6"  method="post" action="m_login.php">
            ...
            <p class="mb-0 font-size-sm text-center text-muted">
              Don't have an account yet? <a href="register.php">註冊</a>
            </p>
          </div>
        </div> <!-- / .row -->
      </div> <!-- / .container -->
